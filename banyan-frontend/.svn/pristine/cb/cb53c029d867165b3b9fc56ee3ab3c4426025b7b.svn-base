(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('inet-core'), require('rxjs'), require('inet-ui'), require('@angular/forms'), require('ngx-bootstrap'), require('ngx-bootstrap/modal'), require('@angular/router'), require('rxjs/operators'), require('ngx-gallery')) :
    typeof define === 'function' && define.amd ? define('inet-social', ['exports', '@angular/core', '@angular/common', 'inet-core', 'rxjs', 'inet-ui', '@angular/forms', 'ngx-bootstrap', 'ngx-bootstrap/modal', '@angular/router', 'rxjs/operators', 'ngx-gallery'], factory) :
    (global = global || self, factory(global['inet-social'] = {}, global.ng.core, global.ng.common, global.inetCore, global.rxjs, global.inetUi, global.ng.forms, global.ngxBootstrap, global.modal, global.ng.router, global.rxjs.operators, global.ngxGallery));
}(this, (function (exports, core, common, inetCore, rxjs, inetUi, forms, ngxBootstrap, modal, router, operators, ngxGallery) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var SocialService = /** @class */ (function () {
        function SocialService(httpClient, coreService, photoSwipe, socketService, fileFormatService, frontViewService) {
            ...
            this.activityChange = new rxjs.Subject();
            this.commentChange = new rxjs.Subject();
            this._removeTags = [
                'link',
                'meta',
                'script',
        ...
        function (activity) {
            ...
            // Beak line
            message = inetCore.HtmlUtils.formatHtmlDisplay(message);
            // link
        ...
        SocialService.ctorParameters = function () { return [
            ...
            { type: inetCore.CoreService },
            { type: inetUi.PhotoSwipe },
            { type: inetCore.WebSocketClientService },
            { type: inetUi.FileFormatService },
            { type: inetUi.FrontViewService }
        ]; };
    ...
    var ShareMemberComponent = /** @class */ (function () {
        ...
        ShareMemberComponent.ctorParameters = function () { return [
            { type: SocialService },
            { type: inetCore.AccentService }
        ]; };
        ShareMemberComponent.propDecorators = {
            shareModal: [{ type: core.ViewChild, args: ['shareModal',] }],
            inputMember: [{ type: core.ViewChild, args: ['searchInput',] }],
            contactList: [{ type: core.ViewChild, args: ['contactList',] }],
            companyMode: [{ type: core.Input }],
    ...
    var ActivityPostComponent = /** @class */ (function () {
        function ActivityPostComponent(socialService) {
            ...
            this.onPost = new core.EventEmitter();
            this.message = '';
            this.files = [];
            this.removeFiles = [];
        ...
        ActivityPostComponent.propDecorators = {
            activity: [{ type: core.Input }],
            shareMemberEnable: [{ type: core.Input }],
            linkPreviewEnable: [{ type: core.Input }],
            enterPost: [{ type: core.Input }],
            showWithAnimation: [{ type: core.Input }],
            placeHolder: [{ type: core.Input }],
            companyMode: [{ type: core.Input }],
            onCancel: [{ type: core.Output }],
            onPost: [{ type: core.Output }],
            postElement: [{ type: core.ViewChild, args: ['postElement',] }],
            messageEl: [{ type: core.ViewChild, args: ['messageEl',] }],
            shareMember: [{ type: core.ViewChild, args: [ShareMemberComponent,] }],
            messageAutoSize: [{ type: core.ViewChild, args: [inetCore.AutoSizeDirective,] }],
            linkPreview: [{ type: core.ViewChild, args: [inetUi.LinkPreviewComponent,] }],
            indicator: [{ type: core.ViewChild, args: [ProgressComponent,] }]
        };
    ...
    var SocialEmbedComponent = /** @class */ (function () {
        ...
        SocialEmbedComponent.propDecorators = {
            activityID: [{ type: core.Input }],
            contextID: [{ type: core.Input }],
            application: [{ type: core.Input }],
            activity: [{ type: core.Input }],
            allowComment: [{ type: core.Input }],
    ...
    var ActivityComponent = /** @class */ (function () {
        function ActivityComponent(socialService, modalService) {
            ...
            this.onUpdated = new core.EventEmitter();
        ...
        ActivityComponent.propDecorators = {
            activity: [{ type: core.Input }],
            onUpdated: [{ type: core.Output }],
            onDeleted: [{ type: core.Output }],
            policiesDisplay: [{ type: core.ViewChild, args: ['policiesDisplay',] }],
            tmpConfirmDelete: [{ type: core.ViewChild, args: ['tmpConfirmDelete',] }]
        };
    ...
    var SocialModalViewComponent = /** @class */ (function () {
        ...
        SocialModalViewComponent.propDecorators = {
            viewModal: [{ type: core.ViewChild, args: ['viewModal',] }]
        };
    ...
    var ListUserComponent = /** @class */ (function () {
        ...
        ListUserComponent.ctorParameters = function () { return [
            { type: SocialService },
            { type: inetCore.AccentService },
            { type: inetCore.CacheStorageService }
        ]; };
    ...
    var GroupMemberComponent = /** @class */ (function () {
        ...
        GroupMemberComponent.propDecorators = {
            ...
            listUser: [{ type: core.ViewChild, args: ['listUser',] }]
        };
    ...
    var SocialGroupComponent = /** @class */ (function () {
        ...
        SocialGroupComponent.propDecorators = {
            modalCreateMember: [{ type: core.ViewChild, args: ['modalCreateMember',] }],
            modalAddMember: [{ type: core.ViewChild, args: ['modalAddMember',] }]
        };
    ...
    var CommentListComponent = /** @class */ (function () {
        function CommentListComponent(socialService) {
            ...
            this.socialService = socialService;
            this.allowComment = true;
            this.commentLoad = new core.EventEmitter();
            this.commentParams = {
                pageSize: 5,
                pageNumber: 0
            };
        ...
        CommentListComponent.propDecorators = {
            activity: [{ type: core.Input }],
            allowComment: [{ type: core.Input }],
            commentLoad: [{ type: core.Output }],
            commentPost: [{ type: core.ViewChild, args: [CommentPostComponent,] }]
        };
    ...
    var ActivityListComponent = /** @class */ (function () {
        ...
        ActivityListComponent.propDecorators = {
            activityPost: [{ type: core.ViewChild, args: ['activityPost',] }],
            postEnable: [{ type: core.Input }],
            scroller: [{ type: core.Input }],
    ...
    var SocialLatestComponent = /** @class */ (function () {
        ...
        SocialLatestComponent.propDecorators = {
            viewMoreEnable: [{ type: core.Input }]
        };
        ...
        SocialModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [
                            common.CommonModule,
                            forms.FormsModule,
                            inetUi.PhotoSwipeModule,
                            forms.ReactiveFormsModule,
                            inetUi.OpenGraphModule,
                            inetUi.AutocompleteModule,
                            ngxBootstrap.BsDropdownModule.forRoot(),
                            modal.ModalModule.forRoot(),
                            inetUi.FrontViewModule,
                            inetCore.CoreModule,
                            FileListModule,
                            inetUi.DateTimeModule
                        ],
                        exports: [
                            ProgressComponent,
                        ...
                        providers: [
                            SocialService,
                            inetCore.CacheStorageService,
                            inetCore.AccentService,
                            inetUi.FileFormatService
                        ]
                    },] }
        ];
        return SocialModule;
    ...
    var SocialFriendComponent = /** @class */ (function () {
        ...
        SocialFriendComponent.propDecorators = {
            _tabViewContainer: [{ type: core.ViewChild, args: ['tabViewContainer', { read: core.ViewContainerRef },] }],
    ...
    exports.ActivityPostComponent = ActivityPostComponent;
    exports.ActivityViewComponent = ActivityViewComponent;
    exports.FriendBrowseComponent = FriendBrowseComponent;
    exports.FriendInvitationComponent = FriendInvitationComponent;
    exports.SocialAppModule = SocialAppModule;
    exports.SocialComponent = SocialComponent;
    exports.SocialEmbedComponent = SocialEmbedComponent;
    exports.SocialGroupComponent = SocialGroupComponent;
    exports.SocialLatestComponent = SocialLatestComponent;
    ...
    exports.ɵf = ProgressComponent;
    exports.ɵg = ShareMemberComponent;
    exports.ɵh = AttachmentListComponent;
    exports.ɵi = CommentComponent;
    exports.ɵj = CommentPostComponent;
    exports.ɵk = CommentListComponent;
    exports.ɵl = MessageBodyComponent;
    exports.ɵm = LocalNews;
    exports.ɵn = ActivityActionMoreComponent;
    exports.ɵo = SocialModalViewComponent;
    exports.ɵp = ListUserComponent;
    exports.ɵq = GroupCreateComponent;
    exports.ɵr = GroupMemberComponent;
    exports.ɵs = SocialRoutingModule;
    exports.ɵt = SocialHomeComponent;
    exports.ɵu = SocialActivityViewComponent;
    exports.ɵv = SocialFriendComponent;
    exports.ɵw = SocialRightLayoutComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=inet-social.umd.js.map
