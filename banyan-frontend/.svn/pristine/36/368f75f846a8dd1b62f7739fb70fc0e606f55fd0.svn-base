import { __decorate, __metadata, __values, __spread, __assign, __awaiter, __generator, __extends, __param } from 'tslib';
import { Injectable, ComponentFactoryResolver, ApplicationRef, Injector, Output, Input, Component, EventEmitter, Inject, ElementRef, NgModule } from '@angular/core';
...
var FORMAT$5 = mapMomentDateFormatWithFieldType(FieldType.dateEuro);
...
var FORMAT$6 = mapMomentDateFormatWithFieldType(FieldType.dateEuroShort);
...
var FORMAT$7 = mapMomentDateFormatWithFieldType(FieldType.dateIso);
...
var FORMAT$8 = mapMomentDateFormatWithFieldType(FieldType.dateUs);
...
var FORMAT$9 = mapMomentDateFormatWithFieldType(FieldType.dateUsShort);
