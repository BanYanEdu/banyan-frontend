...
export declare const Formatters: {
    ...
    icon: import("../models/formatter.interface").Formatter;
    /** Displays a Font-Awesome edit icon (fa-info-circle) */
    infoIcon: import("../models/formatter.interface").Formatter;
    /** show input text value as italic text */
    italic: import("../models/formatter.interface").Formatter;
