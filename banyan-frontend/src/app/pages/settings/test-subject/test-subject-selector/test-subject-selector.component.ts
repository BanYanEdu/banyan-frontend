...
@Component({
    selector: 'app-test-subject-selector',
    templateUrl: './test-subject-selector.component.html'
})
export class TestSubjectSelectorComponent implements OnInit {
    @Input() uuid: string;
    ...
    ngOnInit() {
        ...
        this.settingsService.testSubjectList({ inactive: false }).subscribe(data => {
