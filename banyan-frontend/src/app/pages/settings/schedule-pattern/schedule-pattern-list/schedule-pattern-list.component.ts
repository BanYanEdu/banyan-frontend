...
export class SchedulePatternListComponent extends BaseListComponent<SchedulePattern> implements OnInit {
    ...
    protected callLoadList(callbackFn: Function, errorFn: Function): void {
        ...
        this.settingsService.schedulePatternList(this.params).subscribe(data => callbackFn(data), error => errorFn(error));
    }
