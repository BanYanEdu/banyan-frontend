...
@Component({
    selector: 'app-aa-type-list',
    templateUrl: './aa-type-list.component.html'
})
export class AATypeListComponent extends BaseListComponent<AAType> implements OnInit {
    ...
    protected callLoadList(callbackFn: Function, errorFn: Function): void {
        ...
        this.settingsService.aaTypeList(this.params).subscribe(data => callbackFn(data), error => errorFn(error));
    }
