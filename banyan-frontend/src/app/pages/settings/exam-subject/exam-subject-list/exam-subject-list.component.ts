...
export class ExamSubjectListComponent extends BaseListComponent<ExamSubject> implements OnInit {
    ...
    protected callLoadList(callbackFn: Function, errorFn: Function): void {
        ...
        this.settingsService.examSubjectList(this.params).subscribe(data => callbackFn(data), error => errorFn(error));
    }
