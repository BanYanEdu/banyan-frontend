...
import { EmployeeProfileConfig } from 'app/model/settings/EmployeeProfileConfig';
import { FormMode } from 'app/model/common/FormMode';

@Component({
    selector: 'app-employee-profile-config',
    templateUrl: './employee-profile-config.component.html'
})
export class EmployeeProfileConfigComponent extends BaseAddDialogComponent<EmployeeProfileConfig>{
    ...
    protected callUpdateItem(requestItem: BaseEditableMdModel, callbackFn: Function): void{
        this.settingsService.employeeProfileConfigUpdate(requestItem).subscribe(data => callbackFn(data));
    }
