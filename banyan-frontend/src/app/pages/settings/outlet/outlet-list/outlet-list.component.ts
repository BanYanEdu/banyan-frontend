...
export class OutletListComponent extends BaseListComponent<Outlet> implements OnInit {
    ...
    protected callLoadList(callbackFn: Function, errorFn: Function): void {
        ...
        this.settingsService.outletList(this.params).subscribe(data => callbackFn(data), error => errorFn(error));
    }
