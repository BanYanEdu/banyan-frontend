...
import { Genders } from 'app/data/global/Genders';
import { EmploymentStatuses } from 'app/data/global/EmploymentStatuses';
import { WorkingTypes } from 'app/data/global/WorkingTypes';
import { EducationLevels } from 'app/data/global/EducationLevels';
...
export class EmployeeAddComponent extends BaseAddDialogComponent<Employee>{
    ...
    genders: any[] = Genders;
    employmentStatuses: any[] = EmploymentStatuses;
    workingTypes: any[] = WorkingTypes;
    eduLevels: any[] = EducationLevels;
